...
function Skills() {
  ...
  return (
    ...
    >
      <h2 className={`text-4xl font-bold mb-12 border-b-2 transform transition-all duration-1000 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>Skills</h2>
